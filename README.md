...
The aim to create several swappable camera control scripts for a top-down terraforming simulator.

Here is the document that details the type of camera controllers I will implement for this exercise:  
